...
const CAR_DATA: Record<BodyType, Vehicle[]> = {
  suv: [
    {
      ...
      engineImage: "/toyota-prado-engine.jpg",
  ...
  offroad: [
    ...
    },
    {
      ...
      interiorImage: "/toyotahilux-revo-interior.jpg",
      backImage: "/toyotahilux-revo-back.jpg",
      engineImage: "/toyotahilux-revo-engine.jpg",
